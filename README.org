...
- ~SEARCH~ (optional) is an Org search string (heading, line number, regex)
...
#+begin_example
[[orgit-file:~/CODE/0-EMACS/emacs-packages/orgit-file/::ef662d3::orgit-file.el::10]]
